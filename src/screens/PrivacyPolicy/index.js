...
import {Dimensions, ScrollView, Text, View, Linking, Platform} from 'react-native';
import {PROXIMA_NOVA_BOLD} from '../../components/Constants/Fonts';
import PrivacyPolicyImg from '../../components/assets/PrivacyPolicyImg.svg';
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
      ...
      <Text style={styles.txt}>
        ...
        <Text
          onPress={() => {
            Linking.openURL('https://keyki.pk/');
          }}
          style={{fontFamily:Platform.OS==='web'?'PROXIMA_NOVA_BOLD': PROXIMA_NOVA_BOLD, color: 'blue'}}>
          keyki.pk (Click here to open site)
        </Text>{' '}
        operated by Keyki online Pvt Limited(Registration Number: '0080047'. We
      ...
      <Text style={styles.txt}>
        ...
        explains the steps we have taken to secure your personal
        information.Finally, this Privacy Policy explains your options regarding
        the collection, use, and disclosure of your personal information.By
        visiting the Site directly or through another site, you accept the
        practices described in this Policy.{' '}
      </Text>

      <Text style={styles.txt}>
        Data protection is a matter of trust and your privacy is important to
        us.Therefore, we shall only use your name and other information that
        relates to you in the manner set out in this Privacy Policy.We will only
        collect information where we must do so and we will only collect
        information if it is relevant to our dealings with you.{' '}
      </Text>

      <Text style={styles.txt}>
        We will only keep your information for as long as we are either required
        to by law or as is relevant for the purposes for which it was collected.{' '}
      </Text>
      ...
      <Text style={styles.txt}>
        ...
        time can we identify you unless you have an account on the Site and log
        on with your user name and password.
      </Text>

      {/* 2nd Heading */}
      <Text style={styles.heading}>1. Data that we collect</Text>
      ...
      <Text style={styles.txt}>
        We collect, store, and process your data to process your purchase on the
        Site and any possible later claims and provide you with our services. We
        may collect personal information including, but not limited to, your
        title, name, gender, date of birth, email address, postal address,
        delivery address (if different), telephone number, mobile number, fax
        number, payment details, payment card details or bank account details.
      </Text>
      ...
      <Text style={styles.txt}>
        ...
        carry out financial transactions with payments you make; audit the
        downloading of data from our website; improve the layout and/or content
        of the pages of our website and customize them for users; identify
        visitors on our website; carry out research on our users' demographics;
      ...
      <Text style={styles.txt}>
        We may pass your name and address on to a third party to make delivery
        of the product to you (for example to our courier or supplier). You must
        only submit to us the Site information which is accurate and not
      ...
      <Text style={styles.txt}>
        ...
        open, and those which are short to be dispatched and administer your
      ...
      <Text style={styles.txt}>Other uses of your Personal Information </Text>
      <Text style={styles.txt}>
      ...
      <Text style={styles.txt}>
        ...
        'unsubscribe’ link in any email that we send to you. Within 7 working
        days (days which are neither (i) a Sunday, nor (ii) a public holiday
        anywhere in Pakistan) of receipt of your instruction, we will cease to
        send you information as requested. If your instruction is unclear we
        will contact you for clarification.
      </Text>

      <Text style={styles.txt}>
        We may further anonymize data about users of the Site generally and use
        it for various purposes, including ascertaining the general location of
      ...
      <Text style={styles.txt}>Competitions </Text>
      <Text style={styles.txt}>
        ...
        terms for the respective competition.
      </Text>

      <Text style={styles.txt}>Third Parties and Links </Text>
      <Text style={styles.txt}>
      ...
      <Text style={styles.txt}>
        We may exchange information with third parties for the purposes of fraud
        ...
        for any third party to whom we transfer your data under our Privacy
        Policy.
      </Text>
      ...
      <Text style={styles.txt}>
        ...
        activation of cookies. Cookies are tiny text files that identify your
        ...
        remembering who you are when you want to amend your shopping cart
        ...
        is free from viruses. If you want to find out more information about
        cookies, go to https://www.allaboutcookies.org or to find out about
      ...
      <Text style={styles.txt}>
        ...
        to evaluate your use of the website, compiling reports on website
      ...
      <Text style={styles.txt}>
        ...
        your password and to your computer.
      </Text>
